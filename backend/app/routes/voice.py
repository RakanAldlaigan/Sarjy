...
async def chat(
    ...
    with timing.start_turn() as timer:
        with timing.db_phase("session"):
        ...
        try:
            ...
            timing.set_transcript_len(len(transcript))
            ...
            if len(history) == 1:
                ...
                with timing.span("memory", db_phase="memory"):
            ...
            for _ in range(MAX_TOOL_ROUNDS):
                ...
                with timing.span("tool_calls", db_phase="tool"):
            ...
            with timing.db_phase("db_persist"):
        ...
        timing.attach_header(timer, response)
        return ChatResponse(
